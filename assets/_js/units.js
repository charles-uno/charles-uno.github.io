...
//    var unit_toggle = document.createElement("span");
//    unit_toggle.id = "unit-toggle";
//    unit_toggle.innerHTML = '<label class="switch"><input type="checkbox" onclick="toggleUnits();"><span class="slider round"></span></label><span class="imperial">metric</span><span class="metric">imperial</span>';
//    ingredients.parentNode.insertBefore(unit_toggle, ingredients);
