...
Generative AI has recently become "smart" enough to take on all sorts of white-collar tasks. It can write code better than an entry level software engineer. 
...
Generative AI has significantly decreased the cost of outsourcing work to the computer. It can write code better, faster, and cheaper than an entry-level software engineer. It's also good with spreadsheets, flowcharts, calendars, and emails. 

The software engineering industry has been shaken up from top to bottom. Established engineers spend more time talking to AI than to people. Fresh grads are facing the worst job market in decades. Educators have seen their curriculum and teaching strategies become moot overnight. 

Students 

senior software engineers work more with machines than people
junior engineers can't get jobs because the market doesn't know what to do with them


technical skills are getting eclipsed by human skills

Human skills like creativity and judgment are more important than ever, though sometimes it's not clear what that means in the trenches

As software integrations mature, we're also finding that AI is able to absorb all sorts of other white-collar bookkeeping. 
