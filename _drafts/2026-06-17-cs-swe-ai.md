...
[Nobody is hiring][entry_level_collapse] junior software engineers because, frankly, they're not very useful right now. Fresh computer science grads are in a rough spot. I wish I could offer answers here. Instead I just have a big question: when today's senior engineers want to retire, who will replace them?

[fire]: https://en.wikipedia.org/wiki/FIRE_movement

<!--
- Without an influx of new junior engineers, software engineering will be an aging profession. What happens when today's senior engineers want to retire? 
- I built my expertise on a foundation of Python scripts. Tomorrow's senior engineers will talk to the machine using words instead. 
...
Today's senior engineers built their expertise on a foundation of mechanical skills: object-oriented programming, config files, and shell scripts. Tomorrow's senior engineers will talk to the machine using words. Some of them may not even have a background in computer science at all. Their expertise will be built on creativity, curiosity, judgment, systems thinking, and communication skills. 
-->
...
Engineers on low-level systems will be less affected. This includes anyone working on compilers, operating systems, devices, databases, site reliability, machine learning, and so on. A lot of [middleware][middleware] probably falls into this category too. Based on a [recent industry survey][swe_breakdown], this accounts for about a third of software engineers. Computer science fundamendals are deeply relevant to these roles. They need to understand the ugly, tedious, and confusing parts of the machine -- their whole job is to engage with those parts and hide them from everyone else!
...
I don't know about other industries, but software engineering jobs specifically want you to have a major in computer science or a related field.
