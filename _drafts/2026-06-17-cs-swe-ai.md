...
I am not rooting for AI

I am not telling you that you need to use it
...
Students have access to AI. It would be near-impossible to prevent them from using it. And, honestly, maybe that's fine! Part of college is preparing students for the "real world", and it certainly seems like AI is here to stay. That said, AI does introduce some very real challenges for educators. 

First: we have to rework grading. Homework just isn't a valuable signal anymore. AI makes it possible for students to turn in flawless homework regardless of how much (or little) they have absorbed. We'll probably lean more into in-person assessments such as closed-book exams and live presentations. It's also important to do some assessment as early in the term as possible. Students may not realize how much they've glossed over until they sit down to take an exam without AI. An early reality check gives them the best chance to correct course. 

Second: we need to adjust the curriculum. Human skills like creativity, judgment, and communication are important. Mechanical skills are scaffolding at best. I'm personally spending much less time on programming syntax. This gives more time to talk about security and system design, as well as for open-ended [projects][project_based_learning]. 

Finally: we need to help students avoid self-destructive AI use. In my mind, this is the big one. 




Researchers recently [published a study][china_ai_study] looking at how AI use impacted school performance. The top-line numbers are about what you would expect: the average student is getting better scores on homework, spending less time on it, and performing worse on tests. In other words, they're outsourcing their homework to AI, engaging less with the material, and learning less themselves. 

But some students, about one in five, defied the average. They spent just as much time on homework as their non-AI-user peers. These students saw their test scores *increase* instead of decrease. The idea is that those students are using AI as a tutor, rather than as a machine that spits out the answers.
...
Some students intuitively know how to use AI in a positive way. Maybe more will figure it out naturally as they gain experience. I think it also makes sense for us, as educators, to confront the issue head-on. We can use both carrots and sticks to nudge our students away from self-destructive AI use. 

To paraphrase [Titus Winters][tw]: I assign homework in the hope that it will lead to learning. I do not actually want to read twenty essays about instruction-level parallelism. What I want is for my students to sit down and use their brains. 


For example:

- Honesty. AI is excellent at correctly answering questions about computer science. I'm not going to exaggerate the risk of hallucination to scare them away. I *am* going to explicitly call out the risk of chort-circuiting their own learning. 
- Structure. I model "good" AI use to my students by using it interactively to dig into points of confusion. I also give them time to do the same during lab exercises. 
- Freedom. I'm adding an open-ended final project to my course. I ask students to engage creatively with the material beyond what we cover in class. AI use is explicitly allowed, as long as they use it to build something appropriately ambitious. 
- In-person assessment. My grading leans heavily on closed-book exams and in-person presentations. The first assessment is just a few weeks into the term. Students may not realize how much they've glossed over until they sit down to take an exam without AI. I want to maximize their chance to course-correct. 


- Clear goals. I have explicit learning goals for each chapter. This is what they will be tested on. All homework clearly aligns to those goals. 


- Temptation mitigation. If homework is worth half your grade, there's a big incentive to use AI to ensure you get it "right". But that's not the point of homework. 

The world does not need another essay about Lord of the Flies. 

I'm glad to not be teaching reading or writing. any sort of remote learning also seems horrible
