...
- water use
- data centers
- slop on social media. gross
- artist jobs. this sucks but I don't see a way to do anything about it. levels the playing field. easy to create stuff that is "good enough" which kills demand for the really good stuff
...
These same tools are plenty "smart" to disrupt other white-collar professions as well. 

Amid the upheaval, I think there's room for optimism. 

AI does not devalue human qualities
