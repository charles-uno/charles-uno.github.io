...
Fiddly computer tasks exist in other industries too. Teachers and bankers and salespeople spend plenty of time reading emails and writing spreadsheets. For better or for worse, it will become clear to everyone that AI is better than humans at all sorts of white-collar bookkeeping. The forward march of AI isn't unique to software engineering; it just hit us *first*. This makes sense for a few reasons:
...
- Software engineers love to write little programs to automate the tedious parts of our jobs. Pretty much every tool we use has a text interface via the Linux terminal. This same interface is very convenient for AI integrations. Buttons and dropdowns and other "pretty" interfaces are trickier to use programmatically.
- AI can respond very differently depending on how a prompt is phrased. Software engineers are good at [problem decomposition][problem_decomposition], which helps write effective prompts. We also have just had a lot of practice since our bosses [pushed us to adopt it early][big_tech_early_ai]. 
...
Other industries will catch up. Wrappers will pop up to help AI agents use proprietary data formats. Industry-specific software will add AI-friendly integration points. AI prices will [drop in the long run][moores_law] (though they may [go up first][reduced_subsidies]). AI models today are fundamentally "smart" enough to absorb the mechanical work from all sorts of different white-collar professions. It's just a matter of time before they get plugged in. 
