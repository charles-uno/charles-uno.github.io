...
- [First Step Act][trump_criminal_justice_reform] (bipartisan) --- Criminal justice reform which reduced mandatory minimum sentencing, ended solitary confinement for minors, mandated de-escalation training for correctional officers, and more. This bill also included $0.4 billion for rehabilitation programs to reduce recidivism. Over 3,000 prisoners were released early in the first year. However, the administration also [faced criticism][trump_sabotage_first_step_act] for its reluctance to fully implement the law.
...
- [Bipartisan Infrastructure Law][bh_infrastructure_bill] (bipartisan) --- $1,200 billion to modernize roads, bridges, public transit, broadband, and so on. Passing a big infrastructure package had been a [long-term goal][obama_and_trump_infrastructure] for both parties. 
