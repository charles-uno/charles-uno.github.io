...
- Trump implemented a policy of [separating families at the border][family_separation] to deter the flood of asylum seekers at the border[^border_asylum]. Thousands of children (including infants) were held in federal custody. A judge later ordered Trump to reunite the families, but doing so took years due to poor recordkeeping. The policy was [not effective][family_separation_ineffective] at reducing asylum claims.
...
- Biden/Harris border policies have made it [more difficult][bh_title_42] to claim asylum, but [easier][bh_easier_immigration_tougher_asylum] to [immigrate][bh_citizen_spouse] legally. These changes are small compared to the scale of the border crisis[^border_asylum]. 
