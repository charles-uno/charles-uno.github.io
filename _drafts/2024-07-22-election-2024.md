...
- They created a program to distribute free COVID [tests by mail][covid_tests_by_mail], and shipped a billion of them.
- They [donated][global_vaccines] 700 million vaccine doses globally.
- They issued [official guidance][bh_covid_plan] for schools and workplaces during COVID. In particular, this guidance included recommendations for how and when to relax precautions as the pandemic wound down. 
- Democrats also [passed][bh_stimulus_bill] an additional $1,900 billion in stimulus spending. This made pandemic support in the US [more generous][g20_stimulus_comparison] that in most of Europe. Critics [worried][bh_stimulus_concerns] that so much spending would lead to massive inflation. In fact, the US saw a [faster recovery][post_covid_gdp] than any other wealthy nation: lower unemployment, slower inflation, and faster GDP growth. [Wages are rising][wage_growth], especially for [low-income workers][low_income_wages]. Income inequality is [falling][income_inequality_falling]. 
...
[covid_test_by_mail]: https://www.npr.org/sections/health-shots/2023/09/21/1200750128/free-covid-tests-by-mail
