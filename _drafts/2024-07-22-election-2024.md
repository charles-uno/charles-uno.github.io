...
**The US is the backbone of NATO, the alliance that has kept the peace in Europe since World War II. We are the largest source of funding for international organizations such as the UN and World Bank. We also have a complex relationship with the Middle East due to our long history of both [starting][operation_praying_mantis] [conflicts][iraq_war] and [mediating][clinton_two_state_solution] [them][gaza_ceasefire_2012]. The president is the top authority on all of this, within the budgets set by Congress.**
