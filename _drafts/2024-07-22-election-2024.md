...
**The president is the commander in chief of the strongest military in human history. For better or worse, much of the current world order is dependent on that strength. The US deters Russian expansion in Europe, as well as Chinese aggression against Taiwan. We also have a complicated history in the middle east, where we've historically been both a [combatant][iraq_war] and a [mediator][clinton_two_state_solution].**
