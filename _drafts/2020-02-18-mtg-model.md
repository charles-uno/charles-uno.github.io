...
[^4]: For a rundown of how [[Once Upon a Time]] and [[Dryad of the Ilysian Grove]] affected Amulet Titan, check out [this piece](http://magic.facetofacegames.com/how-theros-broke-amulet-titan/) by Daryl Ayers. 
...
A year ago, we might have looked at the odds of casting [[Primeval Titan]] by turn four. [[Once Upon a Time:OUAT]] improves the deck's consistency to a point where that's no longer interesting. 

The table below shows 



The vast majority of Amulet Titan hands can goldfish a [[Primeval Titan]] by turn four. 
