...
[[Arboreal Grazer]] doubles our odds of casting [[Primeval Titan]] on turn two. [[Sakura-Tribe Scout]] is a few percentage points ahead on turn three -- but that's against a non-interactive opponent. There's no way that small advantage holds up in the face of [[Fatal Push]], [[Lightning Bolt]], and [[Pithing Needle]]. 





The selling point of [[Sakura-Tribe Scout:Scout]] is that it can activate at instant speed, dropping in a [[Bojuka Bog]] in response to [[Past in Flames]] or a bounce land to defend against [[Field of Ruin]]. 

That's not nothing, but in my assessment it's not enough. 
...
The statistical uncertainty is ±1%, so the difference between 2% and 3% is not significant on its own. But with several data points, we can see a trend.
...
, but those numbers come with a caveat. The model assumes a non-interactive opponent. 

If our opponent has a [[Fatal Push]] or [[Lightning Bolt]], [[Sakura-Tribe Scout:Scout]] doesn't do anything at all. 


There's no way that small advantage holds up in the face of [[Fatal Push]], [[Lightning Bolt]], and [[Pithing Needle]]. 
...
[[Arboreal Grazer]] gives the deck a significant boost on turn two. [[Sakura-Tribe Scout]] appears to perform marginally better on turn three, but let's take those numbers with a grain of salt. The model assumes a non-interactive opponent. 




[[Arboreal Grazer]] is probably better than [[Sakura-Tribe Scout]]. 
...
If even a small fraction of our opponents play [[Fatal Push]] or [[Lava Dart]], [[Arboreal Grazer]] 
