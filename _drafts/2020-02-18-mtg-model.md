...
These new cards are relevant to any [[Primeval Titan]] deck, but for the sake of brevity we're looking at Amulet Titan. We're also not getting into numbers for [[Once Upon a Time]] or [[Dryad of the Ilysian Grove]]. Both cards are so obviously powerful that they saw near-universal adoption from the moment they were available. Instead, we're looking at three questions that (judging from [decklist aggregators](https://www.mtggoldfish.com/metagame/modern#paper)) remain unresolved:
...
Numbers are based on the following deck list:
