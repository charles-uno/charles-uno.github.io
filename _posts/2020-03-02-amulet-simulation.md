...
![Example Output](/assets/images/wide/mtg-model-amulet-t3.png)
<p class="figure-caption">Above is example output from the model. It knows how to track multiple colors of mana, transmute [[Tolaria West]], and use both mana abilities on [[Castle Garenbrig]].</p>
